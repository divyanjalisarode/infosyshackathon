...
if (isset($_GET['logout'])) {
    session_destroy();
    echo "<script>alert('Logged out successfully!'); window.location.href='second.php';</script>";
    exit;
}
?>
<!DOCTYPE html>
...
header {
    ...
    align-items: center;
    padding: 20px 50px;
    background: linear-gradient(135deg, #6b48ff 0%, #ff6f91 100%);
    color: white;
...
#educationContent, #budgetTracker, #financialPlanning, 
#investmentTracker, #sipCalculator, #emiCalculator, #dashboardContent {
    max-width: 1000px;
    margin: 0 auto;
    background-color: #fff;
    border-radius: 10px;
...
.back-btn:hover {
    background-color: #e65b7f;
}

/* Form and input styling */
.tracker-form, .goal-form, .investment-form, .calculator-container {
    display: flex;
    flex-wrap: wrap;
    gap: 10px;
    margin-bottom: 20px;
